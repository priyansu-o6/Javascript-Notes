...
for (const item of menu) console.log(item); // item is created in every iteration ; const item = menu[0] -> const item = menu[1]
...
const arr = [1, 2]; // it is important to decalre 'arr' here because [1,2] in rest.set and rest.get would be different objects in the heap
rest.set(arr, 'Test');
...
console.log(Object.entries(openingHours)); // because Object.entries gives us a similar structure to array of arrays
...
> <img width="1917" height="1078" alt="Screenshot 2026-08-29 035911" src="https://github.com/user-attachments/assets/779fcf40-57da-4fb2-a082-bbf22caad12d" />


### Arrays vs. Sets and Objects vs. Maps
> <img width="1917" height="1078" alt="Screenshot 2026-08-29 040016" src="https://github.com/user-attachments/assets/1cd0f6bd-ef3b-4889-bf19-b5de106a11dc" />
